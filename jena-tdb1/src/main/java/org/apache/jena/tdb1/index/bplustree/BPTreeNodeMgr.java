...
import static org.apache.jena.tdb1.base.block.BlockType.BPTREE_BRANCH;
import static org.apache.jena.tdb1.base.block.BlockType.BPTREE_LEAF;
import static org.apache.jena.tdb1.base.block.BlockType.RECORD_BLOCK;
...
public final class BPTreeNodeMgr extends BPTreePageMgr<BPTreeNode>
{
    ...
    public int createEmptyBPT()
    {
        ...
        if ( recordsPage.getId() != BPlusTreeParams.RootId )
            throw new TDB1Exception("Root blocks must be at position zero (got "+recordsPage.getId()+")") ;
        // Empty data block.
        recordsPage.write();
        recordsPage.release() ;
